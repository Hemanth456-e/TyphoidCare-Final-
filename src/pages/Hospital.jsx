...
function Workflow({current="training"}){
 ...
 return (
  ...
  )<strong>{s[0]}</strong><small>Federated process</small><em className={s[2]}>{s[1]}</em></div>{i<3&&<ChevronRight className="arrow"/>}</React.Fragment>)}</div>
}
